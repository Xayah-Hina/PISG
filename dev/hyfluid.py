...
class HyFluidPipeline:
    ...
    def train_density_only(self):
        ...
        train_video_data_numpy = load_videos_data_high_memory(self.video_infos, dataset_type="train").astype(self.dtype_numpy) / 255.0  # (#videos, #frames, H, W, C)
